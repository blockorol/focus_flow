...
export function CreateFlowForm({ onCreate }: CreateFlowFormProps) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setTags('');
      setDescription('');
      setCreatedMessage('Flow created.');
    } catch (cause) {
    ...
    <Card>
      <CardHeader>
        <div>
          ...
          <CardDescription>Start from one root Focus and add deeper structure later.</CardDescription>
        </div>
      </CardHeader>
      <CardContent>
