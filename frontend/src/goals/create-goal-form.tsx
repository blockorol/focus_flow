...
import { Button, Card, CardContent, CardDescription, CardHeader, CardTitle, Field, Select, Textarea } from '@/ui';
...
export function CreateGoalForm({ onCreate }: CreateGoalFormProps) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setDescription('');
      setStatusOverride('');
      setCreatedMessage('Goal created.');
    } catch (cause) {
    ...
    <Card>
      <CardHeader>
        <div>
          ...
          <CardDescription>Add an outcome for this Focus.</CardDescription>
        </div>
      </CardHeader>
      <CardContent>
