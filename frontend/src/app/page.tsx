    ...
    <AuthGate>
      <main className="mx-auto grid min-h-screen max-w-6xl gap-8 px-6 py-10 lg:grid-cols-[260px_1fr]">
        ...
        <section className="grid content-start gap-6">
          <SessionSummary />
          <div>
            <Badge tone="info">Mock auth ready</Badge>
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-text-primary">Make room for what matters.</h1>
            <p className="mt-3 max-w-2xl text-base leading-7 text-text-muted">Sign in through mock mode to preview the protected FocusFlow workspace.</p>
          </div>
          ...
          <EmptyState title="App shell comes next" description="The next step will turn this protected preview into the main sidebar layout." />
        </section>
      </main>
    </AuthGate>
  );
